...
1. Delete the src and public directory and all of its contents.
1. Create a new public directory and a new index.html file inside of public.
1. Use the ! emmet shortcut to generate a fresh html document in the index.html file. Place <div id="root"></div> in the <body> of the html document you created. (like we did in earlier videos!)
1. Create a new src directory and a components directory inside of src.
1. Create an App.jsx and a index.js file inside of src.
1. Write the basic "entry point" code for the index.js file, avoid copy/paste so you can practice writing it yourself!
...
1. Head to your terminal and start this React project with npm start. Make sure it renders your App component without any errors!
